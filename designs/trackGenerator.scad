...
module curve(r1=nincoRad1, r2=nincoRad2, deg = 45, center = true, copperWidth=12)
{
  ...
  translate([0, -aux, 0]) difference()
  {
    union()
    {
      ...
      color("Gainsboro")
      {
	translate([0, nincoTrackWidth-nincoTrack1, nincoTrackHeight-0.1]) curvedSlot(r1 = r1+nincoTrack1-copperWidth/2, r2 = r1+nincoTrack1+copperWidth/2, d=0.5, deg=deg);
	translate([0, nincoTrackWidth-nincoTrack2, nincoTrackHeight-0.1]) curvedSlot(r1 = r1+nincoTrack2-copperWidth/2, r2 = r1+nincoTrack2+copperWidth/2, d=0.5, deg=deg);
      }
    }
